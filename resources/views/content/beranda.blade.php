...
<html lang="en">
    <head>
        ...
        <link
            rel="stylesheet"
            href="../../AdminLTE/AdminLTE-3.2.0/plugins/fontawesome-free/css/all.min.css"
        />
        <!-- Ion Slider -->
        <link
            rel="stylesheet"
            href="../../AdminLTE/AdminLTE-3.2.0/plugins/ion-rangeslider/css/ion.rangeSlider.min.css"
        />
        <!-- bootstrap slider -->
        <link
            rel="stylesheet"
            href="../../AdminLTE/AdminLTE-3.2.0/plugins/bootstrap-slider/css/bootstrap-slider.min.css"
        />
        <!-- Theme style -->
        <link
            rel="stylesheet"
            href="../../AdminLTE/AdminLTE-3.2.0/dist/css/adminlte.min.css"
        />
    </head>
    <body class="hold-transition sidebar-mini">
        ...
        <!-- Ion Slider -->
        <script src="../../AdminLTE/AdminLTE-3.2.0/plugins/ion-rangeslider/js/ion.rangeSlider.min.js"></script>
        <!-- Bootstrap slider -->
        <script src="../../adminlte/AdminLTE-3.2.0/plugins/bootstrap-slider/bootstrap-slider.min.js"></script>
        <!-- AdminLTE for demo purposes -->
        <script src="../../admin/AdminLTE-3.2.0/dist/js/demo.js"></script>
